                            ...
                            (
                                ...
                                >
                                    <div className="flex flex-wrap items-start justify-between gap-4">
                                        ...
                                        <span
                                            className={`rounded-full px-3 py-1 text-xs font-medium ${scanClass(
                                    ...
                                    <div className="mt-5 flex flex-wrap gap-2">
                                        ...
                                        {documentRecord.can_delete && (
                                            <button
                                                ...
                                                className="inline-flex items-center gap-2 rounded-md border border-red-200 bg-white px-4 py-2 text-xs font-semibold uppercase tracking-widest text-red-600 hover:bg-red-50"
                                            >
